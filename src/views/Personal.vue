      ...
      <el-card class="box-card">
        ...
        <el-tabs v-model="activeName">
          <el-tab-pane label="基本资料" name="first">
            <el-form :model="adminDetail" :rules="editFormRules" ref="editFormRef" label-width="80px">
              <el-form-item label="用户头像" prop="icon">
                <el-upload :headers="headers" class="avatar-uploader" :action="uploadIconUrl" :show-file-list="false" :on-success="handleAvatarSuccess">
                  <img v-if="icon" :src="icon" class="avatar" title="点击更换头像" />
                  <img v-else :src="adminDetail.icon" class="avatar" title="点击更换头像" />
                </el-upload>
              </el-form-item>
          ...
          <el-tab-pane label="修改密码" name="second">
            <el-form :model="updateForm" :rules="updateFormRules" ref="updateFormRef" label-width="80px">
              <el-form-item label="旧密码" prop="password">
                <el-input type1="password" v-model="updateForm.password" placeholder="请输入旧密码" />
              </el-form-item>
              <el-form-item type1="password" label="新密码" prop="newPassword">
                <el-input v-model="updateForm.newPassword" placeholder="请输入新密码" />
              </el-form-item>
              <el-form-item type1="password" label="确认密码" prop="resetPassword">
...
export default {
  ...
  data() {
    return {
      ...
      activeName: 'first',
      uploadIconUrl: '/api/upload', //'http: //localhost:2002/api/upload',
      headers: {
