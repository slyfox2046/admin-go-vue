<template>
  <el-container class="home-container">
    <el-aside :width="isCollapse ? '64px' : '200px'">
      ...
      <el-menu background-color="#304156" text-color="#fff" unique-opened router :default-active="$route.path" :collapse="isCollapse" :collapse-transition="false">
        <!-- 无子集菜单 -->
      ...
      <el-header>
        ...
        <div class="bread-btn">
          <el-breadcrumb separator="/" v-if="$router.currentRoute.path != '/welcome'">
            <el-breadcrumb-item :to="{ path: '/welcome', name: '' }">首页</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '', name: '' }">{{ $route.meta.sTitle }}</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '', name: '' }">{{ $route.meta.tTitle }}</el-breadcrumb-item>
          </el-breadcrumb>
